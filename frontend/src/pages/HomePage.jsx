...
import { HeartHandshake, Globe, Users, TrendingUp, ArrowRight, Flame } from "lucide-react";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-screen bg-gray-50">
      ...
      <div className="col-span-1 lg:col-span-3">
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeIn}
          className="bg-gradient-to-r from-blue-600 to-teal-500 text-white py-16 px-4"
        >
      ...
      {/* Right Sidebar - Modified to match FeedPage style */}
